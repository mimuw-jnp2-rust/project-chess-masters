...
pub fn mouse_pos_to_coordinates(x: f32, y: f32, width: u32, height: u32) -> Coordinates {
    //println!("Old mouse position {} {}", x, y);
    let new_x = x - width as f32 / 2.0;
    let new_y = y - height as f32 / 2.0;
    // println!("Mouse pos: ({}, {})", new_x, new_y);
    Coordinates {
